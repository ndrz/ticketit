...
@section('ticketit_content')
    {!! CollectiveForm::open([
        ...
        <div class="form-group row">
            {!! CollectiveForm::label('Number', trans('ticketit::lang.noid') . trans('ticketit::lang.colon'), ['class' => 'col-lg-2 col-form-label']) !!}
            <div class="col-lg-10">
                {!! CollectiveForm::text('noid', null, ['class' => 'form-control', 'required' => 'required']) !!}
                <small class="form-text text-muted">{!! trans('ticketit::lang.create-no-ticket') !!}</small>
            </div>
        </div>        

        <div class="form-row mt-6">
            <div class="form-group offset-sm-2 col-sm-4 row">
                {!! CollectiveForm::label('company', trans('ticketit::lang.company') . trans('ticketit::lang.colon'), ['class' => 'col-sm-6 col-form-label']) !!}
                <div class="col-sm-6">
                    {!! CollectiveForm::select('company', $companies, null, ['class' => 'form-control', 'required' => 'required']) !!}
                </div>
            </div>            
        </div>
        ...
        <div class="form-row mt-6">
            ...
            <div class="form-group offset-sm-2 col-sm-4 row">
                {!! CollectiveForm::label('issue', trans('ticketit::lang.issue') . trans('ticketit::lang.colon'), ['class' => 'col-sm-6 col-form-label']) !!}
                <div class="col-sm-6">
                    {!! CollectiveForm::select('priority_id', $priorities, null, ['class' => 'form-control', 'required' => 'required']) !!}
                </div>
            </div>
            <div class="form-group offset-sm-2 col-sm-4 row ">
                {!! CollectiveForm::label('sub_issue', trans('ticketit::lang.sub_issue') . trans('ticketit::lang.colon'), ['class' => 'col-sm-6 col-form-label']) !!}
                <div class="col-sm-6">
