            ...
            @foreach($agents as $agent)
                <tr>
                    ...
                    <td>
                        ...
                        <div class="input-group input-group-sm mb-1">
                            ...
                            <div class="input-group-prepend">
                              <div class="input-group-text">
                                <input name="agent_cats[]" type="checkbox" aria-label="Checkbox for following text input" value="{{ $agent_cat->id }}"
                                {!! ($agent_cat->agents()->where("id", $agent->id)->count() > 0) ? "checked" : ""  !!} >
                              </div>
                              
                            </div>
                            <input type="text" class="form-control" value="{{ $agent_cat->name }}">
                        ...
                        {!! CollectiveForm::submit(trans('ticketit::admin.btn-join'), ['class' => 'btn btn-info btn-sm right']) !!}
